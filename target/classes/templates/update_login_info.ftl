...
<div class="layui-form layui-form-pane" action="">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="last_change_password_dt" id="last_change_password_dt" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>        
    <div class="layui-form-item"> 
...
function resetAttritubesByFile(){//通过文件设置属性
	...
	var password=$("#password").val();
	 if($(":radio[name='type']:checked").val()=="acc_num"){
		  url="/weblogin/update_login_info/file/acc_num";
		  /* data=JSON.stringify({                    
			  loginName: account,  
		  ...
		  url="/weblogin/update_login_info/file/login_name";
		  /* data=JSON.stringify({                    
			  loginName: account,  
			  loginAttempt: parseInt(login_attempt),  
			  firstLogin: is_first_login,
	...
	function resetAttritubesByHand(){ //手动输入属性
		...
		var password=$("#password").val();
	  if($(":radio[name='type']:checked").val()=="acc_num"){
		  url="/weblogin/update_login_info/acc_num";
		  data=JSON.stringify({                    
			  accNum: account,  
			  loginAttempt: parseInt(login_attempt),  
			  firstLogin: is_first_login,
		  ...
		  url="/weblogin/update_login_info/login_name";
		  data=JSON.stringify({                    
			  loginName: account,  
			  loginAttempt: parseInt(login_attempt),  
			  firstLogin: is_first_login,
